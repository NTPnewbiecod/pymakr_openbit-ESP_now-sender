...
class led_matrix():
    ...
    def led_matrix_active(self):
        """init and send color data to neopixel matrix. to put it simply, this func just make neopixel light up 
        """
    ...
    def led_matrix_fill(self, color: tuple):
        ...
        Args:
            color (tuple): tuple that contain RGB (int between 0 -255) eg. (255, 255, 255)
        """
